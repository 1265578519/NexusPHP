...
--
-- 主机: localhost:3306
-- 生成日期: 2024 年 09 月 30 日 20:18
-- 服务器版本: 5.6.43-log
-- PHP 版本: 5.6.33

-- 找到数据库agent_allowed_family表单导入，由于php有缓存，24小时后生效
-- 该agent_allowed_family表只写入qBittorrent 5.0.0以上版本支持，无需清空表，直接原有表覆盖导入即可
...
(null, 'qBittorrent 5.0', 'qBittorrent 5.0.0', '/^-qB5([0-9])([0-9A-Z])([0-9])-/', 3, 'hex', '-qB5000-', '/^qBittorrent\\/5\\.([0-9])\\.([0-9]+)/', 2, 'dec', 'qBittorrent/5.0.0.0', 'no', 'yes', '', 0);
